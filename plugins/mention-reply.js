    ...
    if (m.mentionedJid.includes(botNumber)) {
      ...
      await conn.sendMessage(m.chat, {
        ...
        contextInfo: {
          ...
          isForwarded: true,
          externalAdReply: {
            title: config.BOT_NAME || "MASKY-MD 🥀",
            body: config.DESCRIPTION || "MASKY MD 🤌💗",
            mediaType: 1,
            renderLargerThumbnail: true,
            thumbnail: thumbnailBuffer,
            mediaUrl: "https://files.catbox.moe/r2ncqh", // Static image URL
            sourceUrl: "https://wa.me/2348074548225?text=Hello%20sir%20MASKY%20MD%20Official%20developer",
