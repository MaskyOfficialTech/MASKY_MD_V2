...
cmd({
    ...
    try {
        if (!isCreator) {
            return reply(
                "🚫 *Owner Only Command!* You're not authorized to view bot configurations. If you also need MASKY MD V2 YOU CAN View channel below \n source: https://whatsapp.com/channel/0029VbBOLGnBPzjadFglXS3R",
                { contextInfo: { mentionedJid: [m.sender] }, quoted: mek }
            );
        }
}
        let envSettings = `
